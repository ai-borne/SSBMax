...
export const commonStrings = {
  ...
  gto: {
    gtoTitle: 'Stage II: GTO Outdoor & Indoor Tasks (9 Tasks)',
    gtoSubtitle: 'Group Testing Officer evaluation covering Group Discussion, Planning, Structure Tasks, Obstacles, Lecturette, and Command Task.',
