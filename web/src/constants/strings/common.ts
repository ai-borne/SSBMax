export const commonStrings = {
  ...
  subscription: {
    ...
    ribbonSubtitle: 'Choose Free, Pro, or Premium to unlock authentic SSB test simulators & AI evaluations.',
    ribbonFreeTitle: 'Free',
    ribbonFreePrice: '₹0 / Month',
    ...
    ribbonProTitle: 'Pro',
    ribbonProPrice: '₹499 / Month',
    ribbonProBadge: 'PRO',
    ribbonProFeature1: 'Stage I PPDT Story Canvas & Narration',
    ribbonProFeature2: 'Unlimited Stage II Psych Battery (TAT, WAT, SRT, SD)',
    ribbonProFeature3: 'AI Assessor Dossier & 15 OLQ Radar Analytics',
    ribbonProFeature4: '3 GTO Task Simulators per Month & Tactical Guides',
    ribbonProButton: 'Upgrade to Pro',
    ribbonPremiumTitle: 'Premium',
    ribbonPremiumPrice: '₹999 / Month',
    ribbonPremiumBadge: 'PREMIUM',
    ribbonPremiumFeature1: 'All Pro Features Included',
    ribbonPremiumFeature2: 'Live 1-on-1 Mock Personal Interview (3 / Month)',
  ...
  devSettings: {
    ...
    proLabel: 'Force PRO (Tier 1)',
    premiumLabel: 'Force PREMIUM (Tier 2)',
