export const commonStrings = {
  ...
  subscription: {
    ...
    ribbonSubtitle: 'Choose Cadet Pass, Officer Pass, or Command Pass to unlock authentic SSB test simulators & AI evaluations.',
    cadetTitle: 'Cadet Pass',
    cadetPrice: '₹0 / Month',
    cadetBadge: 'CADET (FREE)',
    cadetFeature1: 'Stage I OIR Reasoning Simulators',
    cadetFeature2: 'Basic Practice Tests & Answers',
    cadetFeature3: 'Cached SSB Study Material Guides',
    cadetFeature4: 'Offline Response Queueing',
    cadetButton: 'Active Cadet Pass',
    officerTitle: 'Officer Pass',
    officerPrice: '₹499 / Month',
    officerBadge: 'MOST POPULAR',
    officerFeature1: 'Stage I PPDT Story Canvas & Narration',
    officerFeature2: 'Unlimited Stage II Psych Battery (TAT, WAT, SRT, SD)',
    officerFeature3: 'AI Assessor Dossier & 15 OLQ Radar Analytics',
    officerFeature4: '8 GTO Task Simulators & Tactical Guides',
    officerButton: 'Upgrade to Officer Pass',
    commandTitle: 'Command Pass',
    commandPrice: '₹999 / Month',
    commandBadge: 'COMMANDER',
    commandFeature1: 'All Officer Pass Features Included',
    commandFeature2: 'Live 1-on-1 Mock Personal Interview',
    commandFeature3: 'Personalized IO Assessor Probes & Audio Review',
    commandFeature4: 'Priority Cloud AI Processing & 24/7 Support',
    commandButton: 'Unlock Command Pass'
  },
  gto: {
    ...
    launchSimulator: 'Launch Test Simulator',
    startPractice: 'Start Practice',
    viewGuide: 'View SSB Guide',
    proRequired: 'Pro Officer Required',
    commandRequired: 'Command Pass Required'
  },
  offline: {
