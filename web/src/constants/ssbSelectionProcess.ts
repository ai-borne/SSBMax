...
export const GTO_TASKS: GTOTask[] = [
  ...
  },
  {
    ...
    titleKey: strings.gto.lecturetteTitle,
    descriptionKey: strings.gto.lecturetteDesc,
    category: 'individual',
    timeLimitMinutes: 3,
    accessTier: 'PRO',
    olqsEvaluated: ['Power of Expression', 'Effective Intelligence', 'Self Confidence', 'Reasoning Ability'],
  },
  {
    id: 'iot',
    number: 7,
...
export const SSB_5_DAY_TIMELINE: SSBDayOverview[] = [
  ...
  },
  {
    ...
    subtitle: 'All 9 Group Testing Officer (GTO) indoor & outdoor obstacles and tasks.',
    testCount: 9,
    testTypeIds: ['gd', 'gpe', 'pgt', 'snake_race', 'hgt', 'lecturette', 'iot', 'command_task', 'fgt'],
  },
  {
    dayNumber: '5',
