...
export const CandidateDashboard: FC<CandidateDashboardProps> = ({
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300" data-testid="candidate-dashboard">
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 shadow-md backdrop-blur-sm">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-700/80 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-600/60 text-xs font-semibold text-slate-700 dark:text-slate-200 transition-colors shadow-sm self-start md:self-auto min-h-[44px]"
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-6 pt-4 border-t border-slate-200 dark:border-slate-800 text-xs">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700/80 rounded-2xl p-6 shadow-md dark:shadow-xl dark:shadow-slate-950/60 flex flex-col justify-between" data-testid="stage1-card">
          <div>
          ...
          <div className="space-y-2 pt-2 border-t border-slate-200 dark:border-slate-700/60">
            <button
              ...
              className="w-full min-h-[44px] flex items-center justify-between px-4 py-2.5 rounded-xl bg-sky-600 hover:bg-sky-500 text-white font-bold text-xs transition-all shadow-md shadow-sky-600/20 dark:shadow-sky-900/30"
            ...
            <button
              ...
              className="w-full min-h-[44px] flex items-center justify-between px-4 py-2.5 rounded-xl bg-slate-100 dark:bg-slate-700/80 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-600/60 text-slate-700 dark:text-slate-200 font-semibold text-xs transition-all"
        ...
        <div className="bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700/80 rounded-2xl p-6 shadow-md dark:shadow-xl dark:shadow-slate-950/60 flex flex-col justify-between" data-testid="stage2-card">
          <div>
            <div className="flex items-center justify-between mb-3">
          ...
          <div className="pt-2 border-t border-slate-200 dark:border-slate-700/60">
            <button
              ...
              className="w-full min-h-[44px] flex items-center justify-between px-4 py-3 rounded-xl bg-gradient-to-r from-amber-600 to-amber-500 hover:from-amber-500 hover:to-amber-400 text-white font-bold text-xs transition-all shadow-md shadow-amber-600/20 dark:shadow-amber-950/40"
      ...
      <div className="bg-white dark:bg-slate-800/90 border border-slate-200 dark:border-slate-700/80 rounded-2xl p-6 shadow-md dark:shadow-xl dark:shadow-slate-950/60">
        ...
        <div className="bg-slate-50 dark:bg-slate-950/80 border border-slate-200 dark:border-slate-800 rounded-xl p-4 text-center">
