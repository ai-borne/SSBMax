    ...
    DocSection(
        ...
        blocks = listOf(
            ListBlock(items = listOf(
                ...
                "problem-solving",
                "**Snake Race / Group Obstacle Race**: The whole group carries a continuous connected load (the " +
                "\"snake\") across a series of obstacles as fast as possible -- tests coordinated group speed and " +
                ...
                "limit",
                "**Individual Obstacles Test (IOT)**: A timed course of ~10 physical obstacles attempted " +
                "individually; scored by how many are completed correctly within the time limit",
    ...
    DocSection(
        ...
        blocks = listOf(
            ListBlock(items = listOf(
                ...
                "Task count: 9 distinct GTO exercises, in order -- GD, GPE, PGT, Snake Race, HGT, Lecturette, " +
                "Individual Obstacles, Command Task, and FGT",
