...
/**
 * The INTERVIEW topic's introduction text, split out of [TopicContentLoader]
 * purely to keep every generated file under the repo's 300-line Quality
 * Limit -- no behavior change from having it inline.
 *
 * GENERATED from content/topics/INTERVIEW.md by
...
internal fun interviewIntroduction(): String = """
    ...
    **How the Interview Is Structured**
    ...
    - **Extracurriculars and hobbies**: Deep follow-up on whatever you listed on your PIQ -- expect specific, detailed questions on anything you claimed as a genuine interest
    - **Current affairs and general awareness**: National and international news, defense-related developments, and your basic understanding of the service you're applying to
    ...
    **How to Prepare**
    ...
    - Practice answering "why the armed forces" and "why this service" in your own words until it's specific and personal, not a memorized line
    ...
    **Key Points to Remember**
    ...
    - It's acceptable to say "I don't know" on a factual question and move on confidently, rather than bluffing
    - The interview is assessed alongside GTO and Psychology results, not in isolation -- consistency across all three matters more than any single strong answer
    """.trimIndent()
